...
export class LoaderModule {
    ...
    private static _entryPointClass: string = 'program.ts';
    ...
    public static async ListModulesSource(): Promise<Array<any>> {
        ...
        const modulesFileName = this.ListModulesFileNmae(rootDirectorySource);
    ...
    private static ListModulesFileNmae(directory: string): Array<string> {
